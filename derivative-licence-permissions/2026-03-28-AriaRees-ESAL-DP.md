...
Authorised Party
----------------
Representative: Aria Rees

Discord Identifier: @transbian

Discord UUID: 652597508027187240

GitHub Account: [ariarees](https://github.com/ariarees)
...
Conditions
----------
1. The authorised party may create a licence derived from or based upon
...
5. This permission applies only to the authorised party identified above
   and may not be transferred to another party.
