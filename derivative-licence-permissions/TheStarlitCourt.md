...
Authorised Party
----------------
Representative: The Starlit Court

Discord Identifier: @self_taught_scribe

Discord UUID: 706629936785653801

GitHub Account: Astral-Scribe
...
Conditions
----------
1. Any derivative licence must clearly state that it is derived from
   the Estrogen Source-Available Licence (ESAL).

2. Attribution to Clove Nytrix Doughmination Twilight as the author
   of the original licence must be preserved.

3. The derivative licence must not claim authorship of the original
   ESAL text.

4. This permission applies only to the authorised party identified
   above.
